...
class AdapterDetailRiwayatActivityMenunggu(
    private val data: GetPemesananDetailResponse.Data?,
    val presenter: DetailRiwayatActivityPresenter
) :
        RecyclerView.Adapter<AdapterDetailRiwayatActivityMenunggu.ViewHolder>() {

    class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(
            R.layout.detail_riwayat_item_dp_cicilan_menunggu, parent, false
        )
