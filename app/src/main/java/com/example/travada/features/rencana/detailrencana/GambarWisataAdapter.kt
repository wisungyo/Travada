package com.example.travada.features.rencana.detailrencana//package com.example.travada.features.rencana.detailrencana
//
...
//
//
//class GambarWisataAdapter(val listGambarWisata: ArrayList<DataGambarWisata>,val presenter: DetailRencanaPresenter) :
