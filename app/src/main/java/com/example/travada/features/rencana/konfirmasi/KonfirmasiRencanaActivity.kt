...
import com.example.travada.features.rencana.result.ResultRencanaActivity
...
class KonfirmasiRencanaActivity : AppCompatActivity(), KonfirmasiRencanaActivityPresenter.Listener {
    ...
    override fun showNextButtonClicked(title: String, subtitle: String) {
        DialogKonfirmasiPemesanan.newInstance(title, subtitle)
            .show(supportFragmentManager, DialogKonfirmasiPemesanan.TAG)
    }
