...
import kotlinx.android.synthetic.main.activity_v_a_invoice.*
import java.io.File
...
class VAInvoiceActivity : AppCompatActivity(), VAInvoicePresenter.Listener {
    private lateinit var presenter: VAInvoicePresenter
    private lateinit var notificationManager: NotificationManagerCompat

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_v_a_invoice)
        presenter = VAInvoicePresenter(this)
